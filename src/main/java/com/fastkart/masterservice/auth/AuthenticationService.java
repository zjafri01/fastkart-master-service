...
import com.fastkart.masterservice.user.UserToken;
import com.fastkart.masterservice.user.UserTokenRepository;
...
public class AuthenticationService {
    ...
    private void saveUserToken(UserToken userToken, String jwtToken) {
    ...
    private void revokeAllUserTokens(UserToken userToken) {
        var validUserTokens = tokenRepository.findAllValidTokenByUser(userToken.getId());
